  ...
  //  setFavorite(!favorite)
    ...
    return(
        <div className={style.product_item}>
         ...
         { /*
            favorite === true ? <button className = {style.favorite_btn_added} onClick = {onClickFavorite}>Товар добавлен в избранное</button> : <button className={style.favorite_btn}onClick={onClickFavorite}>Добавить в избранное</button>
        */  }

            <button className = {style.favorite_btn_added} onClick = {onClickFavorite}>Убрать из избранных</button>  
